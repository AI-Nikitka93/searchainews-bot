...
---
Дата и время: 2026-03-16 18:07
Роль: DevOps инженер и специалист по CI/CD
Сделано: Деплой улучшенного канального формата (RU-заголовки, дедуп, доменный анти-спам).
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Проверить новые посты в канале.
---
Дата и время: 2026-03-16 18:11
Роль: DevOps инженер и специалист по CI/CD
Сделано: Добавлен канал-ключ дедупликации (channel_post_keys) и параметр CHANNEL_DEDUPE_HOURS; миграция D1 выполнена.
...
---
Дата и время: 2026-03-16 18:59
Роль: DevOps инженер и специалист по CI/CD
Сделано: Исправлена очистка саммари (убраны «Заголовок:», «Короткое описание:», «Новости:») и исключены reddit.com/bizzabo.com из канала.
Изменены файлы: cf_worker/src/services/channel.ts, cf_worker/wrangler.toml, docs/PROJECT_HISTORY.md
Следующий шаг: Деплой Worker и проверить новые посты.
---
Дата и время: 2026-03-16 19:00
Роль: DevOps инженер и специалист по CI/CD
Сделано: Деплой чистки канальных саммари и исключения reddit/bizzabo.
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Проверить, что «Заголовок:» и «Короткое описание:» больше не появляются.
---
Дата и время: 2026-03-16 19:04
Роль: DevOps инженер и специалист по CI/CD
Сделано: Канал теперь постит 2–5 новостей за один пост, из разных доменов приоритетно; возвращены все источники.
Изменены файлы: cf_worker/src/services/channel.ts, cf_worker/src/types.ts, cf_worker/wrangler.toml, docs/PROJECT_HISTORY.md
Следующий шаг: Деплой Worker и проверить формат мульти-поста.
---
Дата и время: 2026-03-16 19:05
Роль: DevOps инженер и специалист по CI/CD
Сделано: Задеплоены мульти-посты (2–5 новостей) с приоритетом разных доменов.
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Проверить формат одного поста с 2–5 блоками.
---
Дата и время: 2026-03-16 20:00
Роль: DevOps инженер и специалист по CI/CD
Сделано: Подтвержден лимит 3 новости в одном посте канала и выполнен деплой Cloudflare Worker.
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Проверить, что канал публикует ровно 3 новости за пост.
---
Дата и время: 2026-03-16 20:04
Роль: DevOps инженер и специалист по CI/CD
Сделано: Оценено качество текущих постов и зафиксированы ключевые проблемы формата и контента.
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Внедрить правки формата/фильтров, чтобы убрать академические и дублирующиеся посты.
---
Дата и время: 2026-03-16 20:57
Роль: DevOps инженер и специалист по CI/CD
Сделано: Проведена дополнительная оценка качества ленты (перекос в arXiv, дубли NVIDIA, смешение языков и источников).
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Ужесточить фильтры источников и объединение дублей в один пост.
---
Дата и время: 2026-03-16 21:08
Роль: DevOps инженер и специалист по CI/CD
Сделано: Обновлен RESEARCH_LOG по теме метрик Telegram-каналов; подготовлен набор запросов для Perplexity.
Изменены файлы: docs/RESEARCH_LOG.md, docs/PROJECT_HISTORY.md
Следующий шаг: Получить выжимку Perplexity и синтезировать план улучшений.
---
Дата и время: 2026-03-16 21:11
Роль: DevOps инженер и специалист по CI/CD
Сделано: Проведено самостоятельное web‑исследование (Postmypost), обновлен RESEARCH_LOG с подтвержденными выводами.
Изменены файлы: docs/RESEARCH_LOG.md, docs/PROJECT_HISTORY.md
Следующий шаг: Синтезировать план улучшений бота и канала на основе данных.
---
Дата и время: 2026-03-16 21:21
Роль: DevOps инженер и специалист по CI/CD
Сделано: Внедрены улучшения канала (лимит research, фильтр свежести/суммари, дедуп по теме, активные окна, дневной отчет), обновлена схема D1 и выполнен деплой Worker.
Изменены файлы: cf_worker/src/services/channel.ts, cf_worker/src/types.ts, cf_worker/wrangler.toml, cf_worker/schema.sql, cf_worker/migrations/2026_03_16_add_channel_report_state.sql, docs/PROJECT_HISTORY.md
Следующий шаг: Проверить новые посты в канале и получить daily-report в ADMIN_CHAT_ID.
---
Дата и время: 2026-03-16 23:34
Роль: DevOps инженер и специалист по CI/CD
Сделано: Применены улучшения выдачи /latest и broadcast (дедуп по теме и доменам, фильтр свежести, лимит research), выполнен деплой Worker.
Изменены файлы: cf_worker/src/services/news.ts, cf_worker/src/services/broadcast.ts, cf_worker/src/types.ts, cf_worker/wrangler.toml, docs/PROJECT_HISTORY.md
Следующий шаг: Проверить /latest и broadcast на отсутствие академического перекоса.
---
Дата и время: 2026-03-16 23:39
Роль: DevOps инженер и специалист по CI/CD
Сделано: Ослаблены фильтры канала (окна 09–23, 36ч свежесть, min summary 40, research<=2) и выполнен деплой.
Изменены файлы: cf_worker/wrangler.toml, docs/PROJECT_HISTORY.md
Следующий шаг: Проверить, что посты снова появляются в канале.
---
Дата и время: 2026-03-16 23:40
Роль: DevOps инженер и специалист по CI/CD
Сделано: Повторный деплой Cloudflare Worker для подтверждения настроек канала.
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Проверить публикации в канале в течение 10–15 минут.
---
Дата и время: 2026-03-16 23:44
Роль: DevOps инженер и специалист по CI/CD
Сделано: Сформирован список, что добавить в заметки по нашему новостному боту и каналу.
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Внести пункты в документацию проекта по желанию пользователя.
---
Дата и время: 2026-03-16 23:41
Роль: DevOps инженер и специалист по CI/CD
Сделано: Исправлен сбой пайплайна (None LLM response в ai_analyzer), добавлено игнорирование .wrangler.
Изменены файлы: ai_analyzer.py, .gitignore, docs/PROJECT_HISTORY.md
Следующий шаг: Закоммитить и запушить изменения, затем пересмотреть статус GitHub Actions.
---
Дата и время: 2026-03-16 23:42
Роль: DevOps инженер и специалист по CI/CD
Сделано: Изменения закоммичены и отправлены в GitHub; запущен новый GitHub Actions run.
Изменены файлы: docs/PROJECT_HISTORY.md
Следующий шаг: Дождаться завершения run и проверить статус.
---
Дата и время: 2026-03-16 23:36
Роль: DevOps инженер и специалист по CI/CD
Сделано: Для канала запрещены research‑посты (arXiv и др.), выполнен деплой Worker.
Изменены файлы: cf_worker/wrangler.toml, docs/PROJECT_HISTORY.md
...
---
Дата и время: 2026-03-17 19:30
Роль: DevOps инженер и специалист по CI/CD
Сделано: Добавлены русскоязычные источники (Habr AI/ML/Data Mining, Habr компании Яндекс и Сбер, vc.ru) с AI‑фильтрами; фиды проверены через validate_feeds.py.
Изменены файлы: config.yaml, docs/PROJECT_HISTORY.md
Следующий шаг: Закоммитить и запушить изменения, дождаться запуска пайплайна и проверить новые источники в D1.
---
Дата и время: 2026-03-17 20:25
Роль: DevOps инженер и специалист по CI/CD
Сделано: По результатам web-исследования добавлены новые рабочие источники: Amazon Science, Microsoft Fabric Blog, Databricks Docs Feed, Habr NLP, Habr Big Data, Habr компании VK, T-Банк и Just AI. Рабочий RSS для Yandex Cloud и Sber AI по прямым официальным URL не подтвержден.
Изменены файлы: config.yaml, docs/PROJECT_HISTORY.md
Следующий шаг: Закоммитить и запушить изменения, затем проверить наполнение D1 по новым source_id.
---
Дата и время: 2026-03-17 20:40
Роль: DevOps инженер и специалист по CI/CD
Сделано: Добавлен новый адаптер listing_page для non-RSS news-страниц и подключен источник Mistral AI News; адресный тест показал 1 актуальную статью с датой и полным текстом.
Изменены файлы: scraper.py, config.yaml, docs/PROJECT_HISTORY.md
Следующий шаг: Закоммитить и запушить изменения, затем проверить появление source_id=mistral_ai_news после следующего запуска pipeline.
---
Дата и время: 2026-03-17 20:55
Роль: DevOps инженер и специалист по CI/CD
Сделано: В логике канала добавлен режим breaking-news: high-impact релизы моделей и другие критичные анонсы теперь публикуются одиночным постом, а не попадают в общий hourly-дайджест.
Изменены файлы: cf_worker/src/services/channel.ts, cf_worker/src/types.ts, cf_worker/wrangler.toml, docs/PROJECT_HISTORY.md
Следующий шаг: Закоммитить, задеплоить Worker и проверить, что breaking item публикуется отдельно.
---
Дата и время: 2026-03-17 18:50
Роль: DevOps инженер и специалист по CI/CD
Сделано: Добавлен MISTRAL_API_KEY в GitHub Actions окружение и включена настройка модели; выполнена проверка лимитов через заголовки ответа API.
Изменены файлы: .github/workflows/pipeline.yml, docs/PROJECT_HISTORY.md
Следующий шаг: Закоммитить и запушить изменения, затем убедиться, что секрет MISTRAL_API_KEY задан в GitHub.
---
Дата и время: 2026-03-17 19:10
Роль: DevOps инженер и специалист по CI/CD
Сделано: Изменена частота публикации канала на 1 раз в час (cron 0 * * * *; gap 3600 сек).
Изменены файлы: cf_worker/wrangler.toml, docs/PROJECT_HISTORY.md
